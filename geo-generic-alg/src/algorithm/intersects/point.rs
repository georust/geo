...
// impl_intersects_point_from_coord!(GeometryTraitExt, GeometryTag);
// impl_intersects_point_from_coord!(GeometryCollectionTraitExt, GeometryCollectionTag);
...
// impl_intersects_multipoint_from_point!(GeometryTraitExt, GeometryTag);
// impl_intersects_multipoint_from_point!(GeometryCollectionTraitExt, GeometryCollectionTag);
