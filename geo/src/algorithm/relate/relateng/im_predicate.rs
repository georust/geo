...
impl IMState {
    ...
    pub fn is_dimension(&self, loc_a: CoordPos, loc_b: CoordPos, dimension: Dimensions) -> bool {
        self.im.get(loc_a, loc_b) == dimension
    }
...
const LOCATION_ORDER: [CoordPos; 3] = [CoordPos::Inside, CoordPos::OnBoundary, CoordPos::Outside];
