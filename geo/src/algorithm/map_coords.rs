...
pub trait MapCoords<T, NT> {
    ...
    /// let p1 = Point::new(10., 20.);
    /// let p2 = p1
    ///     .try_map_coords(|Coord { x, y, z, m }| -> Result<_, std::convert::Infallible> {
...
mod test {
    ...
    fn point() {
        ...
        let new_p = p.map_coords(|Coord { x, y, z, m }| (x + 10., y + 100.).into());
    ...
    fn point_inplace() {
        ...
        p2.map_coords_in_place(|Coord { x, y, z, m }| (x + 10., y + 100.).into());
    ...
    fn rect_inplace() {
        ...
        rect.map_coords_in_place(|Coord { x, y, z, m }| (x + 10, y + 20).into());
    ...
    fn rect_map_coords() {
        ...
        let another_rect = rect.map_coords(|Coord { x, y, z, m }| (x + 10, y + 20).into());
    ...
    fn rect_try_map_coords() {
        ...
        let result = rect.try_map_coords(|Coord { x, y, z, m }| -> Result<_, &'static str> {
            Ok((
    ...
    fn line() {
        ...
        assert_relative_eq!(
            line.map_coords(|Coord { x, y, z, m }| (x * 2., y).into()),
            Line::from([(0., 0.), (2., 2.)]),
            epsilon = 1e-6
        );
    }
    ...
    fn linestring() {
        ...
        let line2 = line1.map_coords(|Coord { x, y, z, m }| (x + 10., y - 100.).into());
    ...
    fn polygon() {
        ...
        let p2 = p.map_coords(|Coord { x, y, z, m }| (x + 10., y - 100.).into());
    ...
    fn multipoint() {
        ...
        assert_eq!(
            mp.map_coords(|Coord { x, y, z, m }| (x + 10., y + 100.).into()),
    ...
    fn multilinestring() {
        ...
        let mline2 = mline.map_coords(|Coord { x, y, z, m }| (x + 10., y - 100.).into());
        assert_relative_eq!(
            mline2,
    ...
    fn multipolygon() {
        ...
        let mp2 = mp.map_coords(|Coord { x, y, z, m }| (x * 2., y + 100.).into());
    ...
    fn geometrycollection() {
        ...
        assert_eq!(
            gc.map_coords(|Coord { x, y, z, m }| (x + 10., y + 100.).into()),
    ...
    fn convert_type() {
        ...
        let p2: Point<f32> = p1.map_coords(|Coord { x, y, z, m }| (x as f32, y as f32).into());
    ...
    #[test]
    fn test_fallible() {
        let f = |Coord { x, y, z, m }| -> Result<_, &'static str> {
