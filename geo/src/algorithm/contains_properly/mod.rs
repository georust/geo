...
/// # Performance Note
///
/// Much of this trait is currently implemented by delegating to the [`Relate`](crate::algorithm::Relate) trait
/// - see [`Relate::is_contains_properly`](crate::algorithm::Relate); However, [`ContainsProperly`] may be faster for checking some `Polygon`s.
